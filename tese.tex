...
\translatedtitle{Métodos de IA explicável (XAI) para Redes Neurais Convolucionais}
...
\orientador[fem]{Prof. Dr. Nina S. T. Hirata}
...
I dedicate this work to my family, for allowing me to see further and to dream higher at tough times, and to my friends, for all the supporting. - João Gabriel Araujo Josephik
...
\input{conteudo/01-background}
\input{conteudo/02-lime.tex}
\input{conteudo/03-gradcam}
\input{conteudo/04-feature-visualization}
\input{conteudo/05-final-considerations}
